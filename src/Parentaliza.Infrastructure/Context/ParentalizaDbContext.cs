...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<EventoAgenda> EventosAgendas { get; private set; }
    public DbSet<BebeNascido> BebeNascidos { get; private set; }
    public DbSet<BebeGestacao> BebeGestacoes { get; private set; }
    ...
    public DbSet<ExameSus> ExamesSus { get; private set; }
