...
public class CriarVacinaSusCommand : IRequest<CommandResponse<CriarVacinaSusCommandResponse>>
{
    ...
    public CriarVacinaSusCommand(string? nomeVacina, string? descricao, string? categoriaFaixaEtaria, int? idadeMinMesesVacina, int? idadeMaxMesesVacina)
    {
    ...
    public bool Validar()
    {
        var validacoes = new InlineValidator<CriarVacinaSusCommand>();
