...
public class CriarControleFraldaCommand : IRequest<CommandResponse<CriarControleFraldaCommandResponse>>
{
    ...
    public CriarControleFraldaCommand(Guid bebeNascidoId, DateTime horaTroca, string? tipoFralda, string? observacoes)
    {
    ...
    public bool Validar()
    {
        var validacoes = new InlineValidator<CriarControleFraldaCommand>();
