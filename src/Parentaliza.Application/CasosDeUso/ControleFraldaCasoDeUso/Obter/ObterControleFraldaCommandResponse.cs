...
public class ObterControleFraldaCommandResponse
{
    ...
    public ObterControleFraldaCommandResponse(Guid id, Guid bebeNascidoId, DateTime horaTroca, string? tipoFralda, string? observacoes)
    {
        Id = id;
