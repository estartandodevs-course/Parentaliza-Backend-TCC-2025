...
public class CriarExameSusCommand : IRequest<CommandResponse<CriarExameSusCommandResponse>>
{
    ...
    public CriarExameSusCommand(string? nomeExame, string? descricao, string? categoriaFaixaEtaria, int? idadeMinMesesExame, int? idadeMaxMesesExame)
    {
        NomeExame = nomeExame;
        Descricao = descricao;
    ...
    public bool Validar()
    {
        var validacoes = new InlineValidator<CriarExameSusCommand>();
