...
public class ObterExameSusCommandResponse
{
    ...
    public ObterExameSusCommandResponse(Guid id, string? nomeExame, string? descricao, string? categoriaFaixaEtaria, int? idadeMinMesesExame, int? idadeMaxMesesExame)
    {
        Id = id;
        NomeExame = nomeExame;
        Descricao = descricao;
