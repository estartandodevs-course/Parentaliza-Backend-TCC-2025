...
public class ListarControleLeiteMaternoCommand : IRequest<CommandResponse<PagedResult<ListarControleLeiteMaternoCommandResponse>>>
{
    ...
    public ListarControleLeiteMaternoCommand(
        int page = 1,
        int pageSize = 10,
